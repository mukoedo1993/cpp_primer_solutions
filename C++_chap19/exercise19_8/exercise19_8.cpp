...
OrQuery orqry(Ob1,Ob2);
    Query_base *Qb_ptr=&andqry,*Qb_ptr2=&andqry;//At here, we need to see that Qb_ptr's dynamic type is AndQuery.
    ...
    if(typeid(*Qb_ptr)==typeid(*Qb_ptr))
    std::cout<<"  if(typeid(Qb_ptr)==typeid(Qb_ptr))\n";//YES
if(typeid(*Qb_ptr1)==typeid(*Qb_ptr))
    std::cout<<"  if(typeid(Qb_ptr1)==typeid(Qb_ptr))\n";//NO
if(typeid(*Qb_ptr)==typeid(*Qb_ptr2))
    std::cout<<"  if(typeid(Qb_ptr)==typeid(Qb_ptr2))\n";//YES
