...
int main()
{
  ...
  std::cout<<(Blb1<Blb2)<<" "<<(Blb1>Blb3)<<std::endl;//false false
  std::cout<<(Blbptr1<Blbptr2)<<" "<<(Blbptr3>Blbptr1)<<std::endl;//false true
   std::cout<<(Sv1<Sv2)<<" "<<(Sv3>Sv2)<<std::endl;//false true
