//sec16_4_3: 
#ifndef STRVEC_SEC16_4_3_H
#define STRVEC_SEC16_4_3_H
#include<memory>
#include<iostream>
#include<utility>
#include<string>
...
public:
	...
	//The pattern in the expansion of the template parameter pack, &&, means that
    //each function parameter will be an rvalue reference to its corresponding argument.
