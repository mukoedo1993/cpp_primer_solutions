#ifndef SALES_DATA_VER4_H
#define SALES_DATA_VER4_H
#include <iostream>
#include <string>

//Update: To show how to suppress implicit conversions defined by constructors
...
struct Sales_data {
	...
	double revenue = 0.0;
	Sales_data() = default;
	explicit Sales_data(const std::string& s) :bookNo(s) {} //case a
