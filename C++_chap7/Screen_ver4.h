...
#ifndef SCREEN_VER4_H
#define SCREEN_VER4_H
// Modified Friendship from the whole content of the class Screen to Window_mgr 
//to the function clear only.
/*1: Define the Window_mgr class, which declare, but cannot define,clear. Screen must be
* declared before clear can use the members of Screen.
...
public://location ID for each Screen on the window
	...
	Screen& retrive_screen(ScreenIndex i)
	{
		return screens[i];
	}
