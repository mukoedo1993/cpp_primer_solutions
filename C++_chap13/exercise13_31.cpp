...
{
	//exercise 13_30:
	std::string str1 = "dojo", str2 = "majhong", str3 = "Zhang",str4="guan";
	HasPtr Ob1(str1), Ob2(str2), Ob3(Ob1), Ob4(str3),Ob5(str4);
	Ob1.print(); Ob2.print(); Ob3.print();
	swap(Ob2, Ob3);
	Ob2.print(); Ob3.print();//We have made a correct swap.
	Ob4.print();
	vector < HasPtr >vec= {Ob2, Ob3, Ob4,Ob5};
	sort(vec.begin(), vec.end());
	std::cout << "exercise13_31:\n";
