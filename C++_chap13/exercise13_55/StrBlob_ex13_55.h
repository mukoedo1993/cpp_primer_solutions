#pragma once
#ifndef STRBLOB_EX13_55_H
#define STRBLOB_EX13_55_H
//For C++ primer, section 12_1, page 475:
#include<vector>
#include<iostream>
...
public:
	...
	void push_back(const string& t) { data->push_back(t); std::cout << "push_back(const string& t)\n"; }//copy the element
	void push_back( string &&t) { data->push_back(std::move(t)); std::cout << "push_back( string &&t)\n"; }//move the element
	void pop_back();
	//element access
	string& front()const;
	string& back()const;
...
public:
	...
	ConstStrBlobPtr(const StrBlob* a, size_t sz = 0) :wptr(a->data), curr(sz), normalptr(a)
	{

	}

	const StrBlob* normalptr;
	const std::shared_ptr<const StrBlob>sptr;
