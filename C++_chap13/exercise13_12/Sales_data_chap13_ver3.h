#pragma once
#ifndef SALES_DATA_CHAP13_VER3_H
#define SALES_DATA_CHAP13_VER3_H
//exercise13_12: add a destructor
#include <iostream>
#include <string>
using std::string;
using std::istream;
...
struct Sales_data {
	~Sales_data()
	{
		//To indicate that we called the destructor once.
		std::cout << "Call Sales_data destructor once.\n";
	}
	std::string bookNo;
