#pragma once
//To show sec 13.1.1 The copy constructor
#ifndef SALES_DATA_CHAP13_VER1_H
#define SALES_DATA_CHAP13_VER1_H
...
Sales_data::Sales_data(const Sales_data&orig):
	bookNo(orig.bookNo),//using the string copy constructor
