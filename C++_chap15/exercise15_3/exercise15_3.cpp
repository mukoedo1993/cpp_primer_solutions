...
class Quote{
    ...
    void to_define_bookNo(const std::string&str)
    {
        bookNo=str;
    }
};
...
class Bulk_quote :public Quote{//Bulk_quote inherits from Quote
 public:
 Bulk_quote()=default;
 Bulk_quote(const std::string&str,double sales_price=0.0){price=sales_price;to_define_bookNo(str);}
...
int main()
{
    ...
    Quote basic("str1",13.4); Bulk_quote bulk,bulk1("alcohol",13.4);
